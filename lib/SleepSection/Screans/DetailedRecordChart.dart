...
class _DetailedRecord extends State<DetailedRecord> {
  ...
  Widget build(BuildContext context) {
    List<RecordChartData> _RecordChartData =
        Provider.of<Data>(context).sleepsection.getChartData;
    return Scaffold(
      appBar: AppBar(
              ...
              child: SfCartesianChart(
                ...
                series: <ChartSeries>[
                  BarSeries<RecordChartData, String>(
                    ...
                    xValueMapper: (RecordChartData marks, _) => marks.name,
                    yValueMapper: (RecordChartData marks, _) => marks.Duration,
                  )
                ],
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ' Duration Of The Sleep: ${Duration(seconds: Provider.of<Data>(context).sleepsection.getSleepRecordsInUse.SleepDuration).toString().substring(0, 4)} Hours ',
                        style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 14),
