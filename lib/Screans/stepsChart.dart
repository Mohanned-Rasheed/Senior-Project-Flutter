...
class _ChartState extends State<stepsChart> {
  late final List<chartData> _chartData =
      Provider.of<Data>(context).User.CaloriesSectionData.getStepsChart;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SfCircularChart(
        title: ChartTitle(
            text:
                'Target Steps ${Provider.of<Data>(context, listen: false).User.CaloriesSectionData.getChartTargetSteps}'),
        legend:
