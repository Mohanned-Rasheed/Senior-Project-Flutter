...
class _ChartState extends State<CaloriesChart> {
  late final List<chartData> _chartData =
      Provider.of<Data>(context).User.CaloriesSectionData.getCaloriesChart;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SfCircularChart(
        title: ChartTitle(
            text:
                'Target Calories ${Provider.of<Data>(context, listen: false).User.CaloriesSectionData.getChartTargetCalories}'),
        legend:
