...
class _ChartState extends State<BurntCaloriesChart> {
  late final List<chartData> _chartData =
      Provider.of<Data>(context).User.CaloriesSectionData.getCaloriesBurntChart;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: SfCircularChart(
          title: ChartTitle(
              text:
                  'Target BurnCalories ${Provider.of<Data>(context, listen: false).User.CaloriesSectionData.getChartTargetCaloriesBurning}'),
          legend: Legend(
