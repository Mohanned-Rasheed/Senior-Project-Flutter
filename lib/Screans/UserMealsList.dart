    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            MealsList(context, updateUser),
          ],
        ));
  }

  Flexible MealsList(BuildContext context, void updateUser()) {
    return Flexible(
      child: ListView.builder(
        itemCount:
            Provider.of<Data>(context).CaloriesSectionData.getUserMeals.length,
          ...
          return Provider.of<Data>(context)
              ...
              ? Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Container(
                      child: Text(
                          ' calories: ${Provider.of<Data>(context).CaloriesSectionData.getUserMeals[index].calories} \t\t\t\t\t\t\t\t\t\t\t\t\t\t At ${Provider.of<Data>(context).CaloriesSectionData.getUserMealsDates[index].toString().substring(0, 10)} '),
                    ),
                    trailing: Container(
                      child: IconButton(
                          ...
                          Provider.of<Data>(context, listen: false)
                              .DeleteUserMealsList(
                                  Provider.of<Data>(context, listen: false)
                                      .CaloriesSectionData
                                      .getUserMeals[index]);
                          Provider.of<Data>(context, listen: false).deleteDate(
                              Provider.of<Data>(context, listen: false)
                                  .CaloriesSectionData
                                  .getUserMealsDates[index]);
                          Provider.of<Data>(context, listen: false)
